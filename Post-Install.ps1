...
apt-cyg install ip openssh autossh rsync
install office
...
{
	throw [System.IO.NotImplementedException]
}
...
# Tweaks
Set-ExecutionPolicy RemoteSigned # press y
# Taskbar: only in the large screen
...
# App Config (download from dropbox.com)
# virtuawin
...
# App config (2)
# disable: akamai… (w/ autocad), autodesk…, callnote.exe, Java…, LINE, Microsoft OneDrive, onenote…, national instruments…, Skype
# startup: altdrag
# cygwin
cyg-get rsync zsh openssh  # TODO: apt-cygにする
